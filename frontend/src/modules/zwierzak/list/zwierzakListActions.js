...
import exporterFields from 'modules/zwierzak/list/zwierzakListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'ZWIERZAK_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await ZwierzakService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.zwierzak.exporterFileName'),
