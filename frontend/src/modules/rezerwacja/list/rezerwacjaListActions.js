...
import exporterFields from 'modules/rezerwacja/list/rezerwacjaListExporterFields';
import Errors from 'modules/shared/error/errors';
import Exporter from 'modules/shared/exporter/exporter';

const prefix = 'REZERWACJA_LIST';
...
const actions = {
  ...
  doExport: () => async (dispatch, getState) => {
    try {
      ...
      const response = await RezerwacjaService.list(
        filter,
      ...
      new Exporter(
        exporterFields,
        i18n('entities.rezerwacja.exporterFileName'),
