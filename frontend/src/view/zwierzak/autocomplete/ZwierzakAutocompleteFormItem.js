...
import ZwierzakFormModal from 'view/zwierzak/form/ZwierzakFormModal';
import { connect } from 'react-redux';
import selectors from 'modules/zwierzak/zwierzakSelectors';

class ZwierzakAutocompleteFormItem extends Component {
  state = {
    modalVisible: false,
  };
  ...
  fetchFn = (value, limit) => {
    return ZwierzakService.listAutocomplete(value, limit);
  };
...
export default connect(select)(ZwierzakAutocompleteFormItem);
