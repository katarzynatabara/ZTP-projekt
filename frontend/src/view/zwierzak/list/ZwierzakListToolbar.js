...
class ZwierzakToolbar extends Component {
  doExport = () => {
    ...
    return (
      <Toolbar>
        ...
        {this.props.hasPermissionToAuditLogs && (
          <Link to="/audit-logs?entityNames=zwierzak">
...
function select(state) {
  return {
    ...
    hasPermissionToCreate: zwierzakSelectors.selectPermissionToCreate(
      state,
    ),
    hasPermissionToImport: zwierzakSelectors.selectPermissionToImport(
      state,
    ),
  };
}

export default connect(select)(ZwierzakToolbar);
