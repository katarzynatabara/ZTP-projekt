const ptBR = {
  ...
  entities: {
    zwierzak: {
      ...
      label: 'Zwierzaki',
      menu: 'Zwierzaki',
      exporterFileName: 'Zwierzak_exportados',
      list: {
        menu: 'Zwierzaki',
        title: 'Zwierzaki',
      },
      create: {
        success: 'Zwierzak salvo com sucesso',
      },
      update: {
        success: 'Zwierzak salvo com sucesso',
      },
      destroy: {
        success: 'Zwierzak deletado com sucesso',
      },
      destroyAll: {
        success: 'Zwierzak(s) deletado com sucesso',
      },
      edit: {
        title: 'Editar Zwierzak',
      },
      fields: {
        id: 'Id',
      ...
      view: {
        title: 'Visualizar Zwierzak',
      },
      importer: {
        title: 'Importar Zwierzaki',
        fileName: 'zwierzak_template_importacao',
        hint:
    ...
    rezerwacja: {
      ...
      label: 'Rezerwacje',
      menu: 'Rezerwacje',
      exporterFileName: 'Rezerwacja_exportados',
      list: {
        menu: 'Rezerwacje',
        title: 'Rezerwacje',
      },
      create: {
        success: 'Rezerwacja salvo com sucesso',
      },
      update: {
        success: 'Rezerwacja salvo com sucesso',
      },
      destroy: {
        success: 'Rezerwacja deletado com sucesso',
      },
      destroyAll: {
        success: 'Rezerwacja(s) deletado com sucesso',
      },
      edit: {
        title: 'Editar Rezerwacja',
      },
      fields: {
        id: 'Id',
        'wlasciciel': 'Wlasciciel',
        'zwierzak': 'Zwierzak',
        'przyjazdRange': 'Przyjazd',
        'przyjazd': 'Przyjazd',
        'wyjazdRange': 'Wyjazd',
        'wyjazd': 'Wyjazd',
        'uwagiKlienta': 'UwagiKlienta',
        'uwagiPracownika': 'UwagiPracownika',
        'zdjecia': 'Zdjecia',
        'status': 'Status',
        'anulowanieUwagi': 'AnulowanieUwagi',
        'oplataRange': 'Oplata',
        'oplata': 'Oplata',
        'rachunek': 'Rachunek',
        createdAt: 'Criado em',
      ...
      new: {
        title: 'Novo Rezerwacja',
      },
      view: {
        title: 'Visualizar Rezerwacja',
      },
      importer: {
        title: 'Importar Rezerwacje',
        fileName: 'rezerwacja_template_importacao',
        hint:
          'Arquivos/Imagens devem ser as URLs dos arquivos, separados por espaço. Relacionamentos devem ser os IDs separados por espaço.',
      },
    },
  ...
  roles: {
    ...
    zwierzakEditor: {
      label: 'Editor de Zwierzaki',
      description: 'Acesso de edição aos Zwierzaki',
    },
    zwierzakViewer: {
      label: 'Visualizador de Zwierzaki',
      description: 'Acesso de visualização aos Zwierzaki',
    },
    rezerwacjaEditor: {
      label: 'Editor de Rezerwacje',
      description: 'Acesso de edição aos Rezerwacje',
    },
    rezerwacjaViewer: {
      label: 'Visualizador de Rezerwacje',
      description: 'Acesso de visualização aos Rezerwacje',
    },
  },
