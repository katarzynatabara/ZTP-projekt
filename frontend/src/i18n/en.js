const en = {
  ...
  entities: {
    zwierzak: {
      ...
      label: 'Zwierzaki',
      menu: 'Zwierzaki',
      exporterFileName: 'zwierzak_export',
      list: {
        menu: 'Zwierzaki',
        title: 'Zwierzaki',
      },
      create: {
        success: 'Zwierzak saved successfully',
      },
      update: {
        success: 'Zwierzak saved successfully',
      },
      destroy: {
        success: 'Zwierzak deleted successfully',
      },
      destroyAll: {
        success: 'Zwierzak(s) deleted successfully',
      },
      edit: {
        title: 'Edit Zwierzak',
      },
      ...
      importer: {
        title: 'Import Zwierzaki',
        fileName: 'zwierzak_import_template',
        hint:
    ...
    rezerwacja: {
      ...
      label: 'Rezerwacje',
      menu: 'Rezerwacje',
      exporterFileName: 'rezerwacja_export',
      list: {
        menu: 'Rezerwacje',
        title: 'Rezerwacje',
      },
      create: {
        success: 'Rezerwacja saved successfully',
      },
      update: {
        success: 'Rezerwacja saved successfully',
      },
      destroy: {
        success: 'Rezerwacja deleted successfully',
      },
      destroyAll: {
        success: 'Rezerwacja(s) deleted successfully',
      },
      edit: {
        title: 'Edit Rezerwacja',
      },
      fields: {
        id: 'Id',
        'wlasciciel': 'Wlasciciel',
      ...
      new: {
        title: 'New Rezerwacja',
      },
      view: {
        title: 'View Rezerwacja',
      },
      importer: {
        title: 'Import Rezerwacje',
        fileName: 'rezerwacja_import_template',
        hint:
          'Files/Images columns must be the URLs of the files separated by space.',
      },
    },
  ...
  roles: {
    ...
    zwierzakEditor: {
      label: 'Zwierzak Editor',
      description: 'Edit access to Zwierzaki',
    },
    zwierzakViewer: {
      label: 'Zwierzak Viewer',
      description: 'View access to Zwierzaki',
    },
    rezerwacjaEditor: {
      label: 'Rezerwacja Editor',
      description: 'Edit access to Rezerwacje',
    },
    rezerwacjaViewer: {
      label: 'Rezerwacja Viewer',
      description: 'View access to Rezerwacje',
    },
  },
